...
exports.fallbackDreamSymbols = void 0;
exports.getFallbackExtractedSymbols = getFallbackExtractedSymbols;
exports.fallbackDreamSymbols = {
    "acqua": {
        symbol: "Acqua",
        meanings: {
...
function findSymbolPositionsInText(text, symbols) {
    const positions = [];
...
function getFallbackExtractedSymbols(dreamText, includePositions = false) {
    // Lista di parole chiave da cercare nel testo del sogno
    const keywordsToSymbols = {
        // Acqua e relativi
        "acqua": "acqua",
        "mare": "acqua",
        "oceano": "acqua",
    ...
    exports.fallbackDreamSymbols["gara"] = {
        symbol: "Competizione",
        meanings: {
    ...
    const extractedSymbols = Array.from(foundSymbols).map(symbolKey => {
        const symbol = exports.fallbackDreamSymbols[symbolKey];
        return {
